...
| ------ | ------ |------------------------------------------------------------------------------------|
| Addition | + | int dec_add(decimal value_1, decimal value_2, decimal *result)         |
| Subtraction | - | int dec_sub(decimal value_1, decimal value_2, decimal *result) |
| Multiplication | * | int dec_mul(decimal value_1, decimal value_2, decimal *result) | 
| Division | / | int dec_div(decimal value_1, decimal value_2, decimal *result) |
| Modulo | Mod | int dec_mod(decimal value_1, decimal value_2, decimal *result) |
...
| Operator name | Operators  | Function | 
| ------ | ------ | ------ |
| Less than | < | int dec_is_less(decimal, decimal) |
| Less than or equal to | <= | int dec_is_less_or_equal(decimal, decimal) | 
| Greater than | > |  int dec_is_greater(decimal, decimal) |
| Greater than or equal to | >= | int dec_is_greater_or_equal(decimal, decimal) | 
| Equal to | == |  int dec_is_equal(decimal, decimal) |
| Not equal to | != |  int dec_is_not_equal(decimal, decimal) |
...
| ------ | ------ |
| From int  | int dec_from_int_to_decimal(int src, decimal *dst) |
| From float  | int dec_from_float_to_decimal(float src, decimal *dst) |
| To int  | int dec_from_decimal_to_int(decimal src, int *dst) |
| To float  | int dec_from_decimal_to_float(decimal src, float *dst) |
...
| Returns the integral digits of the specified Decimal; any fractional digits are discarded, including trailing zeroes. | int dec_truncate(decimal value, decimal *result) |
| Returns the result of multiplying the specified Decimal value by negative one. | int dec_negate(decimal value, decimal *result)   |
